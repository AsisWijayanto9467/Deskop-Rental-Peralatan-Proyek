    ...
    public partial class DetailPenyewaan : Form
    {
        ...
        private void LoadHeader()
        {
            try
            {
                ...
                string alasan = row["alasan_penolakan"]?.ToString();
                if (string.IsNullOrWhiteSpace(alasan))
                {
                    lblAlasanPenolakan.Visible = false;
                }
                else
                {
                    lblAlasanPenolakan.Text = $"Alasan Penolakan: {alasan}";
                    lblAlasanPenolakan.Visible = true;
                }
            }
            catch (Exception ex)
            {
